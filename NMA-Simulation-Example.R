...
#-----------------------------------------------#
source("C:/Users/jenni/OneDrive/Documents/Research/Work With Tom/Network Meta Analysis/Manuscript/R Code/NMA-Simulation-Functions.R")
library(tidyr)
library(dplyr)
library(locfit)
...
### Compute PoS
get.pos(fitted.jags.mod = jags.fit, trt.num = 2, mvn = FALSE, nt = 9, piC = 0.09, piE = 0.55, pow = 0.90)
